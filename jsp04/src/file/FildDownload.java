...
public class FildDownload {
	...
	public void fileDown(HttpServletRequest request, 
		...
		// 2. 경로 가져오기
		String saveDir = request.getRealPath("fileUpDown"); //경로 가져옴
		File file = new File(saveDir + "/" + fileName); //파일이름을 붙임.
		...
		response.setHeader("Content-Disposition", 
			...
			//response의 header쪽에 해당 값들을 세팅해주는 것임.
